...
program
  ...
  .option('-d, --domain [domain]', 'Domain for the 23 Video site')
  ...
  .option('-at, --access_token [access_token]', 'OAuth access token')
  .option('-as, --access_secret [access_secret]', 'OAuth access token secret')
  .parse(process.argv);
