...
var visualplatform = Visualplatform(key, secret);
...
module.exports = Visualplatform = function(domain, key, secret, callback_url){
  ...
  var methods = ['/api/analytics/report/event', '/api/analytics/report/play', '/api/album/create', '/api/album/delete', '/api/album/list', '/api/album/update', '/api/comment/add', '/api/comment/delete', '/api/comment/list', '/api/photo/coordinate/add', '/api/photo/coordinate/delete', '/api/distribution/ios/push-notification', '/api/distribution/ios/register-device', '/api/distribution/ios/unregister-device', '/api/license/list', '/api/liveevent/create', '/api/liveevent/delete', '/api/liveevent/list', '/api/liveevent/update', '/api/liveevent/stream/create', '/api/liveevent/stream/delete', '/api/liveevent/stream/list', '/api/liveevent/stream/record', '/api/liveevent/stream/stop', '/api/liveevent/stream/update', '/api/photo/delete', '/api/photo/frame', '/api/photo/get-upload-token', '/api/photo/list', '/api/photo/rate', '/api/photo/redeem-upload-token', '/api/photo/replace', '/api/photo/update', '/api/photo/update-upload-token', '/api/photo/upload', '/api/player/list', '/api/player/settings', '/api/photo/section/create', '/api/photo/section/delete', '/api/photo/section/list', '/api/photo/section/set-thumbnail', '/api/photo/section/update', '/api/session/get-token', '/api/session/redeem-token', '/api/site/get', '/api/photo/subtitle/list', '/api/tag/list', '/api/tag/related', '/api/echo', '/api/user/create', '/api/user/get-login-token', '/api/user/list', '/api/user/redeem-login-token'];
